...
class Mhsan_Admin {
	...
	public function display_settings_page() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/mhsan-admin-display.php';
	...
	public function register_settings_page() {
		...
		add_menu_page(
			...
			__( 'MHSAN Admin', 'mhsan-admin' ),      // page title
			__( 'MHSAN Admin', 'mhsan-admin' ),      // menu title
			'manage_options',                        // capability
			'mhsan-admin',                           // menu_slug
